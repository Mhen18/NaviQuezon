...
///{@template EstablishmentReviewsScreen}
/// Screen for the establishment that the user reviewed.
///{@endtemplate}
class EstablishmentReviewsScreen extends StatefulWidget {
  ///{@macro EstablishmentReviewsScreen}
  const EstablishmentReviewsScreen({super.key});

  static const route = rEstablishmentReviews;

  @override
  State<EstablishmentReviewsScreen> createState() => _ScreenState();
}

class _ScreenState extends State<EstablishmentReviewsScreen> {
                  ...
                  builder: (context, estaState) {
                    ...
                    if (estaState is CubitStateSuccess) {
                      ...
                      for (final esta in list) {
                        ...
                        final estaReviewList = esta.reviews ?? [];

                        if (estaReviewList.isNotEmpty) {
                          for (final review in estaReviewList) {
                      ...
                      if (estaList.isEmpty) {
                        return const ErrorStateContainer(
                          message: 'No establishment review found',
                        );
                      }
